...
Dizzy.Dis_Chances = {
    ...
    {
        {{39, 0}, {55, 100}, {397,0},    {700,0}},
        {{55, 0}, {100, 100}, {164, 33, 67}, {397, 100},    {700,0} } -- [101..164] 33% for main crystal, 67% for secondary crystal
    },
    -- Epic Weapon - almost same as armor
    {
        {{39, 0}, {55, 100}, {397,0},    {700,0}},
        {{55, 0}, {60, 100}, {80, 33, 67}, {100, 100}, {164, 33, 67}, {397, 100},    {700,0} }
    }
}
